...
class Dessert(Menu):
    ...
    def daftardessert(self):
        print("1. Dessert - Bread Toast Choco Cheese with Ice Cream - Rp 35000")
        print("2. Dessert - Onion Ring - Rp 20000")
        print("3. Dessert - Chicken Fingers- Rp 15000")
        print("4. Dessert - Jamur Crispy - Rp 15000")
        print("5. Dessert - Chicken Strip - Rp 20000")
        print("6. Dessert - Cheese cake - Rp 40000")
        print("7. Dessert - Pudding - Rp 20000")
